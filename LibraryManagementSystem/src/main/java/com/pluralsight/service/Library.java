        ...
        try {
                        ...
                        if (parts.length >= 6) {
                            ...
                            if ("Book".equals(type)) {
                                ...
                                try {
                                    ...
                                    logger.error("Invalid duration for movie: " + parts[6] + " (ID: " + id + ")", e);
                                }
            ...
            if (membersFile.exists()) {
                try (BufferedReader reader = new BufferedReader(new FileReader(membersFile))) {
                    ...
                    logger.info("Loaded " + memberCount + " members from members.csv");
                }
            }

            // Load borrowed books relationships from borrowed.csv
            ...
            if (borrowedFile.exists()) {
                try (BufferedReader reader = new BufferedReader(new FileReader(borrowedFile))) {
                    ...
                    logger.info("Loaded borrowed relationships from borrowed.csv");
                }
            }
